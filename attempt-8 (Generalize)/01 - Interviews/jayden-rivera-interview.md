# Interview Transcript: Jayden Rivera

**Persona:** Gen-Z Solo Founder with AI App Idea  
**Date:** February 18, 2026  
**Website:** https://launchpadlab.com/  
**Interviewer:** Automated Usability Interviewer  
**Goals:** (1) Visit the website, (2) Find what they do, (3) Find how to contact them
...
1. **AI Automation & Agentic AI** — "Enabling an autonomous digital workforce." Yo, agentic AI? That's actually fire. I've been deep in the agentic AI discourse on Twitter. The fact that they're doing this is cool.
2. **Web Application Development** — "Bespoke, redefining experiences." Bespoke is such a boujee word but okay, they build web apps. Good.
3. **Mobile Application Development** — "Meeting users where they are." Standard but necessary.
4. **Salesforce Development** — "Solving business problems." And there's the Salesforce. Every agency has a Salesforce practice these days. I personally couldn't care less about Salesforce but I get why it's there.
...
- **Prosci** — "360-Customer View in Salesforce" — 5,400+ users, 30+ countries
- **CDK Global** — "Sales Discovery Portal" — 90% reduction in training time
...
At the very bottom of the homepage there's also an embedded contact form with fields for First Name, Last Name, Company Email, Company, and "How Can We Help You?" — plus a CAPTCHA iframe. Pretty standard lead gen form. They ask for "Company Email" not just "Email" which tells me they're expecting business inquiries, not randos with gmail accounts. That's a little intimidating for a solo founder tbh. I don't have a "company" company yet. I have a Notion doc and a dream.
...
1. **AI Automation & Agentic AI** — "Leverage AI automation capabilities and tooling to streamline operations, reduce costs, drive customer satisfaction, and enhance decision-making capabilities–faster and at scale." Still enterprise-speak but the capability is real.

2. **Web Application Development** — "Build an intuitive, user-friendly digital product that helps your team become more efficient, boost adoption, and differentiate your organization from the competition." Okay this is interesting because it's about differentiation, which is exactly what I want.

3. **Mobile Application Development** — "Deliver a world-class, mobile experience for your apps and websites, shipping to market in **50% less time** than other software development consultancies." WAIT. 50% less time? That's a big claim. I'm lowkey intrigued. If they can actually ship mobile in half the time of other agencies... that's significant for someone like me who needs to move fast.

4. **Salesforce Development** — *skimming* — yeah no, I don't care about Salesforce.

5. **Digital Product Strategy & Design** — "Bring your vision to life with a clear, human-centric product strategy and design that doesn't just look good—it drives engagement and converts." Human-centric design, conversion focus — that's more my language.
...
Okay that's actually sick. 5x faster time to market? 6 weeks to launch? If that's real, that's exactly the kind of speed I need. I'm interested in this Discovery Space Navigator thing. It's like they have their own AI tool to help with product strategy. That shows they're not just talking about AI — they're using it internally too. That's a green flag.
...
- **Agentic AI Deployment** — "Train digital agents to act independently—accessing data, following logic, and escalating when needed." This is basically what I want to build into my app. Agents that can do stuff for users.
- **Integrated Data Workflows** — connecting systems for clean, actionable data
...
- Siloed, Disconnected Systems → Integrated AI pulling data in real time
- Inconsistent Execution → Always-on agents with consistent, rules-driven outcomes
- Limited Team Capacity → Autonomous agents that scale without adding headcount
- Low Data Visibility → Structured data pipelines for real-time decisions
...
2. **Proof of Concept** (3-4 weeks) — build and test a real AI solution
3. **Production Deployment** (2-3 months) — full rollout
4. **Ongoing Optimization** — continuous improvement
...
But ngl, this whole page is very much framed around enterprise automation — Salesforce Agentforce, staffing firms, B2B use cases. I want to build a consumer AI app, not an enterprise automation workflow. The SKILLS are relevant to me, but the FRAMING isn't quite right.
...
- **Kawasaki** — "Optimized Workflows with a Self-Service Portal"
- **Bullhorn** — "AI-Enhanced Self-Service Hub Drives Efficiency Gains"
- **MD Anderson** — "Advanced Cancer Research with Curefaster" — okay that's actually really cool, cancer research platform
- **Whirlpool** — "Transformed Its Testing Labs with a Scalable Web App"
- **Financial Services Firm** — "AI Process Automation Enhanced Efficiency for a Leading Consumer Lender"
- **Healthcare Insurance Platform** — "AI Automation to Streamline Claim Reviews"
- **Lurie Children's Hospital** — "Data-Driven Mental Health App Aids Schools" — that's fire, a mental health app for schools
...
- **John Ball Zoo** — "Streamlined the Checkout Experience for Users"
- **Omaha's Henry Doorly Zoo** — "Scalable Online Ticket App for 25M+ Users" — 25 MILLION USERS. That's consumer scale!
- **Chicago Line Cruises** — "Mobile-Friendly Ticketing Site"
- **Breadcrumb** — "Receives 10 Million Views with New App Debut" — 10 million views? That's consumer traction.
- **Algofast** — "Event-based Trading for the Average Investor" — fintech consumer app
- **NextLot** — "Scaled to $2B+ with a Custom Auction Platform" — two BILLION? That's insane.
- **Prepmedians** — "Engaging, Test-Ready Digital Tools Fast" — edtech
- **Guild Row** — "Mobile-First Member App"

Okay so I was wrong to assume they only do enterprise. Buried in this massive portfolio there ARE consumer-facing apps — Tiny House Listings, Breadcrumb (10M views), Omaha Zoo (25M users), NextLot ($2B!), Algofast. They do have startup/consumer experience, it's just not what they LEAD with. Their marketing is very enterprise-focused but the actual work is more diverse.

That Breadcrumb project getting 10 million views on debut, and NextLot scaling to $2B+ — those are the case studies I wish were on the homepage instead of the Salesforce and workflow stuff. If I were their marketing person I'd lead with those for founders like me.
...
Having a VP of Design and a Head of Product specifically — that tells me design and product thinking are first-class concerns, not afterthoughts. That's important for a consumer app.
...
Three ways to reach out — form, email, phone. Plus LinkedIn. That's good. Multiple channels. I'd probably just email them tbh, or fill out the form.
...
They mention aligning with your internal capabilities: "If you have in-house developers or a tech team, we align our stack choices with their expertise. That way, you're empowered to own and extend the product after launch, not dependent on us forever." That's really important. I'm a dev myself. I want to eventually own and maintain whatever they build. The fact that they think about handoff and empowerment is a huge green flag.
...
- Speed to market is emphasized heavily — 6 weeks to launch, 5x faster, 50% less time.
- The free AI Opportunity Workshop is a great low-commitment entry point.
- Their portfolio is WAY more diverse than the homepage suggests.
- The team is structured with dedicated design, product, and engineering leadership.
...
- The framing doesn't speak to startup founders at all. No mention of startups, MVPs, product-market fit, or early-stage product development.
- The "Company Email" field on the form is mildly intimidating for someone with a personal email address.
- No pricing transparency whatsoever.
- Tech stack listing feels dated — no mention of Next.js, TypeScript-first, Vercel, Supabase.
...
The contact info is easy to find — **contact@launchpadlab.com** or **(312) 888-9651**, plus the form on literally every page. I might actually fill out that form or shoot them an email. The free AI Opportunity Workshop is the lowest-risk way to engage.

**Contact Methods Found:**
- Form on every page (First Name, Last Name, Company Email, Company, Message)
- Email: contact@launchpadlab.com
- Phone: (312) 888-9651
- LinkedIn: linkedin.com/company/launchpad-lab
- Address: 2045 W Grand Ave Ste B PMB 37406, Chicago, IL 60612

...
- Each persona must have:
  ...
  - Instructions for a subagent to explicitly become that persona and nothing more, and also be as verbose as possible. If they need to leave the site because they're not being able to achieve their goalds, they should be free to do so and explain why.
